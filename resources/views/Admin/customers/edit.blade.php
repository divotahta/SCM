                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="telepon" id="telepon" value="{{ old('telepon', $customer->telepon) }}" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    @error('telepon')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <select name="jenis" id="jenis" required
                                        ...
                                        <option value="perorangan" {{ old('jenis', $customer->jenis) == 'perorangan' ? 'selected' : '' }}>Perorangan</option>
                                        <option value="perusahaan" {{ old('jenis', $customer->jenis) == 'perusahaan' ? 'selected' : '' }}>Perusahaan</option>
                                    </select>
                                    @error('jenis')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nama_bank" id="nama_bank" value="{{ old('nama_bank', $customer->nama_bank) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    @error('nama_bank')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" name="pemegang_rekening" id="pemegang_rekening" value="{{ old('pemegang_rekening', $customer->pemegang_rekening) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nomor_rekening" id="nomor_rekening" value="{{ old('nomor_rekening', $customer->nomor_rekening) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div id="preview" class="{{ $customer->foto ? '' : 'hidden' }}">
                                    <img id="preview-image" src="{{ $customer->foto ? asset('storage/' . $customer->foto) : '#' }}" alt="Preview" class="mt-2 h-32 w-32 object-cover rounded-lg">
                                </div>
                            </div>
                        </div>
