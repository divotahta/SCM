        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="bg-red-100 rounded-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-red-800">Total Pembayaran Tertunda</h3>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admin.orders.unpaid') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            <form action="{{ route('admin.orders.update', $order->id) }}" method="POST" class="inline">
                                                ...
                                                <button type="submit" class="text-green-600 hover:text-green-900" 
                                                    onclick="return confirm('Tandai pembayaran sebagai lunas?')">
